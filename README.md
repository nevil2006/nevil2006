  ...
  ### Computer Vision & ML Engineer | Vision-Language Models | Real-World AI Systems
  ...
  > Building applied AI systems in Computer Vision and Machine Learning with real-world impact.
  ...
  ### Embedded IoT-Based Fall Detection System (Academic Mentorship)  
Feb 2026  
Tech: ESP32, MPU6050, Embedded C, I2C, LCD, Buzzer, Wokwi Simulation  

- Mentored a three-member student team in designing and implementing a real-time embedded fall detection system for healthcare safety  
- Implemented deterministic free-fall and impact detection logic using motion sensor thresholds  
- Designed a state-machine based confirmation mechanism to reduce false positives  
- Integrated LCD for real-time system status display and buzzer for alert generation  
- Validated system behavior and logic flow using Wokwi simulation prior to hardware testing  
